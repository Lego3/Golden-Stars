...
internal object JuliaMath {
     ...
     * viewport, the constant *c* must still match what the job was started with, and the live
     * view must still match the dimensions sampled when the render began. Palette is a draw-time
